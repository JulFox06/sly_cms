...
<head>
  ...
  $(document).ready(function(){
    ...
    function test1(){
      ...
      form.append("<label class='text_center'><input type='radio' name='theme' value='1' checked/><img src='../assets/fox-logo.png'></label><label class='text_center'><input type='radio' name='theme' value='2' /><img src='../assets/fox-logo.png'></label><label class='text_center'><input type='radio' name='theme' value='3' /><img src='../assets/fox-logo.png'></label><br>");
