		...
		$("#delete").on("click", function(){
		  $(".selected").each(function(){
		    ...
		    $.ajax({
		      ...
		      data: par,
		      success: function(){
		        $('.page-header').after('<div class="alert bg-success" role="alert"><i class="fa fa-check"></i> Article(s) supprimé(s) avec succés ! <a href="#" class="alert-succes pull-right"><span class="glyphicon glyphicon-remove"></span></a></div>');
		        row.remove();
		      },
		      error: function(){
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/articles.php"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
					    <thead>
					    <tr>
						    <?php
								...
								?>
				        <th data-field="aid" data-sortable="true">ID Article</th>
				        <th data-field="titre"  data-sortable="true">Titre</th>
				        <th data-field="auteur" data-sortable="true">Auteur</th>
				        <th data-field="date_public"  data-sortable="true">Publication</th>
				        <th data-field="date_modif" data-sortable="true">Modification</th>
					    </tr>
					    </thead>
						</table>
						<?php
